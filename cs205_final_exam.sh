...
#!/bin/bash
  ...
  awk '{sum+=$13; next} END{print "Total Non-Legendary Pokemon: " sum/NR}' pokemon.dat

  awk '{sum+=$6; next} END{print "Avg. HP: " sum/NR}' pokemon.dat

  awk '{sum+=$8; next} END{print "Avg. Defense: " sum/NR}' pokemon.dat
